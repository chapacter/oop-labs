...
public class ComplexFunctionsTest {
    ...
    public void testCompositeWithArrayTabulatedAndLinkedListTabulated() {
        ...
        assertEquals(10.0, composite1.apply(2.0), 1e-9); // (2^2)^2 = 16
        ...
        assertEquals(10.0, composite2.apply(2.0), 1e-9); // (2^2) = 4
    }
    ...
    public void testChainWithAndThen() {
        ...
        assertEquals(12.0, chain2.apply(2.0), 1e-9); // tabulatedFunc(4) - экстраполяция
    }
